...
<head>
    ...
    <link rel="stylesheet" href="Styling/signup-styling.css?v=<?php echo time(); ?>">
</head>
...
<body>
    ...
    <div id="logonamediv">
        <center><img src="Assets/logo_200x200.png"></center>
    </div>
                ...
                <center>
                    ...
                    <?php if (isset($_GET['success'])) { ?>
                        <center>
                            ...
                            <center><input type="file" id="image" name="profilepic" accept=".jpg,.png,.gif" required></center>
                            <input type="submit" value="Submit" id="submit">
                            <center>
                                <p>Already a have an account? <a href="login.html">Login here</a></p>
                            </center>
